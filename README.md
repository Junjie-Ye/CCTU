...
> Code for the paper [CCTU: A Benchmark for Tool Use under Complex Constraints](https://arxiv.org/abs/xxxx.xxxxx)
...
- **[2026/03/XX]** Release the data and code for SceIF.
- **[2026/03/XX]** Paper available on [Arxiv](https://arxiv.org/abs/xxxx.xxxxx).

## Leaderboard

### Thinking Mode

| Models | Single-Hop SR | Single-Hop PSR | Parallel Single-Hop SR | Parallel Single-Hop PSR | Multi-Hop SR | Multi-Hop PSR | Parallel Multi-Hop SR | Parallel Multi-Hop PSR | Overall SR | Overall PSR |
|---|---|---|---|---|---|---|---|---|---|---|
